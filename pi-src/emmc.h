...
// Block size (for high speed SD, should be 64)
#define SD_BLOCK_SIZE		512

// Commands for wrtiting/reading blocks
...
{
	SD_CMD_INDEX(0),
	SD_CMD_RESERVED(1), // If using EMBEDDED_MCC_CM: SD_CMD_INDEX(1) | SD_RESP_R3
	SD_CMD_INDEX(2) | SD_RESP_R2,
	SD_CMD_INDEX(3) | SD_RESP_R6,
	SD_CMD_INDEX(4),
	SD_CMD_INDEX(5) | SD_RESP_R4,
	SD_CMD_INDEX(6) | SD_RESP_R1 | SD_DATA_READ, // If using EMBEDDED_MCC_CM: SD_CMD_INDEX(6) | SD_RESP_R1
